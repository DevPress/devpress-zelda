...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'zelda' ),
		'cyrillic'     => __( 'Cyrillic', 'zelda' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'zelda' ),
		'devanagari'   => __( 'Devanagari', 'zelda' ),
		'greek'        => __( 'Greek', 'zelda' ),
		'greek-ext'    => __( 'Greek Extended', 'zelda' ),
		'khmer'        => __( 'Khmer', 'zelda' ),
		'latin'        => __( 'Latin', 'zelda' ),
		'latin-ext'    => __( 'Latin Extended', 'zelda' ),
		'vietnamese'   => __( 'Vietnamese', 'zelda' ),
	);
}
endif;
